...
\subsection*{\large AI.lab UnB \hfill Janeiro de 2024 --- Julho de 2025}
\subtext{\hfill Brasília, DF}
\vspace{0.5em}

%\subtext{\normalsize Projeto Osiris}

Atui em um projeto de alto impacto, chamado Osíris, que surgiu como resultado do \textbf{investimento de R\$ 3,5
...
\vspace{-1.3em}
\subtext{\tiny  Agosto de 2024 --- Julho de 2025}
\vspace{-0.5em}
\begin{zitemize}
