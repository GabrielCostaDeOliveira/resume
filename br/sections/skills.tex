...
\skills{Linguagens}       &&  C, C++, Java, Python, SQL \\ \\
  ...
  \skills{Eng. de Software} &&  Design Patterns, SOLID, clean code, Modelagem de Banco de Dados Relacional, mensagerias, Algoritmos paralelos edistribuídos \& Microsserviços   \\ \\
